...
<template>
    <div class="fixed bottom-0 w-full bg-white py-2 flex justify-around z-40 hidden max-[878px]:flex border-t">
        <div class="flex items-center flex-col w-[33.3%] border-r">
        ...
        <div class="flex items-center flex-col w-[33.3%] border-r" @click="responsiveMenu = !responsiveMenu">
        ...
        <div class="flex items-center flex-col w-[33.3%]">
            <div class="flex items-center">
                ...
                <p class="w-fit text-[11px] bg-[#FE696A] rounded-[50%] px-1 text-white">4</p>
            </div>
            <p class="text-sm text-gray-500">$265.00</p>
        </div>
    </div>
</template>